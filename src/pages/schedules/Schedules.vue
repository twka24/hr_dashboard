    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-6 space-y-6">
      ...
      <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex space-x-2">
          <button
            @click="addSchedule"
            class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-white font-medium shadow hover:bg-blue-700 transform hover:scale-105 transition"
          >
