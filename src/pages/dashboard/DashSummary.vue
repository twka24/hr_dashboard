  ...
  <div class="dashboard-wrapper p-4 sm:p-6 md:p-10 space-y-6 sm:space-y-8">
    ...
    >
      ...
      <div class="flex flex-col lg:flex-row gap-6 flex-1">
        <div
          class="w-full lg:w-1/3 xl:w-1/4 h-[220px] sm:h-[260px] md:h-[300px] lg:h-[320px] relative"
        >
          <canvas ref="chartRef"></canvas>
          <div class="mt-2 text-center text-sm text-gray-700 dark:text-gray-300">
            <span class="font-medium">Hadir:</span> {{ dayCounts.hadir }}&nbsp;
            <span class="font-medium">Ijin/Cuti:</span> {{ dayCounts.cutiIzin }}&nbsp;
            <span class="font-medium">Alpha:</span> {{ dayCounts.alpha }}
          </div>
        </div>
